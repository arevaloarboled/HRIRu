...
namespace LibPDBinding
{
	...
	public static partial class LibPD
	{
		...
		/// <summary>
		/// You almost never have to call this! The only case is when the pdcsharp 
		...
		/// Init PD
		[DllImport("pdcsharp", EntryPoint="libpd_init")]
		private static extern void libpd_init() ;

				
		/// Return Type: void
		[DllImport("pdcsharp", EntryPoint="libpd_clear_search_path")]
		...
		/// Return Type: void
		///sym: char*
		[DllImport("pdcsharp", EntryPoint="libpd_add_to_search_path")]
		...
		///basename: char*
		///dirname: char*
		[DllImport("pdcsharp", EntryPoint="libpd_openfile")]
		...
		/// Return Type: void
		///p: void*
		[DllImport("pdcsharp", EntryPoint="libpd_closefile")]
		...
		/// Return Type: int
		///p: void*
		[DllImport("pdcsharp", EntryPoint="libpd_getdollarzero")]
		private static extern  int getdollarzero(IntPtr p) ;

				
		/// Return Type: int
		///sym: char*
		[DllImport("pdcsharp", EntryPoint="libpd_exists")]
		...
		/// Return Type: int
		[DllImport("pdcsharp", EntryPoint="libpd_blocksize")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_init_audio")]
		...
		///inBuffer: float*
		///outBuffer: float*
		[DllImport("pdcsharp", EntryPoint="libpd_process_raw")]
		...
		*/
		...
		///inBuffer: short*
		///outBuffer: short*
		[DllImport("pdcsharp", EntryPoint="libpd_process_short")]
...
*/
		...
		///inBuffer: float*
		///outBuffer: float*
		[DllImport("pdcsharp", EntryPoint="libpd_process_float")]
		...
		*/
		...
		///inBuffer: double*
		///outBuffer: double*
		[DllImport("pdcsharp", EntryPoint="libpd_process_double")]
		...
		*/
		...
		/// Return Type: int
		///name: char*
		[DllImport("pdcsharp", EntryPoint="libpd_arraysize")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_read_array")]
		...
		*/
		[DllImport("pdcsharp", EntryPoint="libpd_write_array")]
