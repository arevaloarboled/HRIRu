...
namespace LibPDBinding
{
	...
	public static partial class LibPD
	{
		...
		[DllImport("pdcsharp", EntryPoint="libpd_is_float")]
		private static extern int atom_is_float(IntPtr a) ;

		[DllImport("pdcsharp", EntryPoint="libpd_is_symbol")]
		private static extern int atom_is_symbol(IntPtr a) ;

		[DllImport("pdcsharp", EntryPoint="libpd_get_float")]
		private static extern float atom_get_float(IntPtr a) ;

		[DllImport("pdcsharp", EntryPoint="libpd_get_symbol")]
		private static extern IntPtr atom_get_symbol(IntPtr a);
		
		[DllImport("pdcsharp", EntryPoint="libpd_next_atom")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_bind")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_unbind")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_bang")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_float")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_symbol")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_start_message")]
		private static extern  int start_message(int max_length) ;

		[DllImport("pdcsharp", EntryPoint="libpd_finish_message")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_add_float")]
		private static extern  void add_float(float x) ;
		
		[DllImport("pdcsharp", EntryPoint="libpd_add_symbol")]
