...
namespace LibPDBinding
{
	public static partial class LibPD
	{
		...
		[DllImport("pdcsharp", EntryPoint="libpd_noteon")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_controlchange")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_programchange")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_pitchbend")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_aftertouch")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_polyaftertouch")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_midibyte")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_sysex")]
		...
		[DllImport("pdcsharp", EntryPoint="libpd_sysrealtime")]
